...
//                "data/dax/Montage_100.xml",
        ...
        SLACK_TIME_FACTOR = 0.8;

        SimStarter simStarter = new SimStarter(new UniformDistr(0, 1, seed), daxPathList, MyPlanner.class, JobNumComparator.class, true);
        SimStarter simStarter1 = new SimStarter(new UniformDistr(0, 1, seed), daxPathList, MyPlanner.class, DepthComparator.class, true);
        SimStarter simStarter2 = new SimStarter(new UniformDistr(0, 1, seed), daxPathList, MyPlanner.class, LengthComparator.class, true);
        SimStarter simStarter3 = new SimStarter(new UniformDistr(0, 1, seed), daxPathList, MyPlanner.class, JobNumComparator.class, false);
        SimStarter simStarter4 = new SimStarter(new UniformDistr(0, 1, seed), daxPathList, MyPlanner.class, DepthComparator.class, false);
        SimStarter simStarter5 = new SimStarter(new UniformDistr(0, 1, seed), daxPathList, MyPlanner.class, LengthComparator.class, false);
