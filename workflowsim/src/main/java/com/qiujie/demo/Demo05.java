...
//                "data/dax/Montage_25.xml"
        ...
        VMS = 200;
        WorkflowBroker broker = run(new UniformDistr(0, 1, seed), MyPlanner.class, daxPathList);
        WorkflowBroker broker1 = run(new UniformDistr(0, 1, seed), MyPlanner.class, daxPathList);
    ...
    public static WorkflowBroker run(ContinuousDistribution random, Class<? extends WorkflowPlannerAbstract> plannerClass, List<String> daxPathList) throws Exception {
        RANDOM = random;
        // init cloudsim
